...
(function () {
  if (!window.supabase || !window.supabase.createClient) {
    console.error('[Chato] Supabase library not loaded. Make sure the supabase-js CDN script is included before this file.');
    return;
  }
  if (!window.SUPABASE_URL || !window.SUPABASE_PUBLISHABLE_KEY) {
    console.error('[Chato] Missing SUPABASE_URL / SUPABASE_PUBLISHABLE_KEY in supabase-config.js');
    return;
  }
